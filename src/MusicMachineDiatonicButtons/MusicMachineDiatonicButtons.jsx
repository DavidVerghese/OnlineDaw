...
function MusicMachineDiatonicButtons(props) {
  ...
  return <div id="button-parent-div">
    ...
    {(!showInstrumentArray[0] && showInstrumentArray[1] && !showInstrumentArray[2] && !showInstrumentArray[3] ) ? <MusicMachineDiatonicButtonGrids instrumentname={instruments[1]} /> : null}
    {(!showInstrumentArray[0] && !showInstrumentArray[1] && showInstrumentArray[2] && !showInstrumentArray[3] ) ? <MusicMachineDiatonicButtonGrids instrumentname={instruments[2]} /> : null}
    {(!showInstrumentArray[0] && !showInstrumentArray[1] && !showInstrumentArray[2] && showInstrumentArray[3]) ? <MusicMachineDiatonicButtonGrids instrumentname={instruments[3]} /> : null}
